...
from silly_teamwork.models import ProjectMember, ProjectRole, TaskMember, TaskRole
...
async def project_task_context() -> AsyncIterator[ProjectTaskApiContext]:
    ...
    async with factory.begin() as session:
        ...
        session.add_all([leader, owner, member, reviewer, outsider])
        await session.flush()
